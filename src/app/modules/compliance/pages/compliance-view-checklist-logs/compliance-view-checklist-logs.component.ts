...
@Component({
    ...
    templateUrl: './compliance-view-checklist-logs.component.html',
    styleUrls: ['./compliance-view-checklist-logs.component.scss']
})

export class ComplianceViewChecklistLogsComponent implements OnInit {
